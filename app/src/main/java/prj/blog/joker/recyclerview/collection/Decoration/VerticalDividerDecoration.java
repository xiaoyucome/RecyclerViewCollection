...
public class VerticalDividerDecoration extends RecyclerView.ItemDecoration {
    final int OUT_SET_LEFT = 0;
    final int OUT_SET_TOP = 0;
    final int OUT_SET_RIGHT = 0;
    final int OUT_SET_BOTTOM = 25;

    private LinearGradient mLinearGradient = new LinearGradient(0, 0, 0, 100, new int[] {
    ...
    public void getItemOffsets(Rect outRect, View view, RecyclerView parent,
        ...
        if (itemPosition == totalItemCount - 1) {
            ...
            outRect.set(OUT_SET_LEFT, OUT_SET_TOP, OUT_SET_RIGHT, OUT_SET_BOTTOM);
        }
    }
}
